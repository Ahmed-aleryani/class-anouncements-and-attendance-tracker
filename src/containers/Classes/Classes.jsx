...
const Card=(Props)=>{
  ...
  <div className="bg-secondary-100 h-64 rounded-lg mb-6 flex flex-col relative overflow-hidden shadow-xl">
    ...
    <Link to={"/classes/"+Props.posts.classOwnerID} className="flex items-center mt-auto text-primary-100 bg-secondary-200 text-center border-0 py-2 px-4 focus:outline-none hover:bg-primary-200 rounded-xl shadow-xl">
    Go to Classroom
  </Link>
    </div>
  </div>
