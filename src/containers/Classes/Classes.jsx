...
const Classes = (Props) => {
  ...
  return (
    <section
      className="relative text-gray-600 body-font overflow-hidden bg-fixed bg-no-repeat bg-cover w-full h-auto sm:h-screen"
      ...
      <div className="relative w-full h-full">
        ...
        <div className="container py-16 mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            {classes
              ? classes &&
                classes.map((classRooms) => <Card posts={classRooms} />)
              : ""}
          </div>
        </div>
      </div>
